...
class __TwigTemplate_f7ec5f1f7750f476a5eeb37b37bbc6ea extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield "CombodoCKEditorHandler.CreateInstance('#";
        ...
        yield "', ";
        yield json_encode(CoreExtension::getAttribute($this->env, $this->source, ($context["oUIBlock"] ?? null), "GetConfig", [], "method", false, false, false, 1));
        yield ");
";
        yield from [];
    }

...
class __TwigTemplate_b4970245d54dc09af4a8f70e8125b0a4 extends Template
{
    ...
    public function block_iboPopoverMenuItem(array $context, array $blocks = []): iterable
    {
        ...
        yield "\" target=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["oUIBlock"] ?? null), "GetTarget", [], "method", false, false, false, 4), "html", null, true);
        yield "\"
            ";
        // line 5
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["oUIBlock"] ?? null), "HasDataAttributes", [], "method", false, false, false, 5)) {
            // line 6
            yield "                ";
...
";
    ...
    {
        return new Source("", "base/components/popover-menu/item/mode_url.html.twig", "C:\\xampp\\htdocs\\itop\\web\\templates\\base\\components\\popover-menu\\item\\mode_url.html.twig");
    }
}

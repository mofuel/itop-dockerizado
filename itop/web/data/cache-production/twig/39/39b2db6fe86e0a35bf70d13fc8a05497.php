...
class __TwigTemplate_0589f638dc1df535259c7d31c1ef5188 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $_v0 = ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            $oAlert_69eaeee188e00329373812 = Combodo\iTop\Application\UI\Base\Component\Alert\AlertUIBlockFactory::MakeForWarning(            $sTitle            ,             $sContent            ,             $sId            );
            ...
            foreach ($aSetters as $sSetter) {
                if (isset($aParams["{$sSetter}"])) {
                    $sCmd = "Set{$sSetter}";
                    call_user_func([$oAlert_69eaeee188e00329373812, $sCmd], $aParams["{$sSetter}"]);
                }
            }
            ...
            foreach ($aAdders as $sAdder) {
                if (isset($aParams["{$sAdder}"])) {
                    call_user_func([$oAlert_69eaeee188e00329373812, $sAdder], $aParams["{$sAdder}"]);
                }
            }
            end($context['UIBlockParent'])->AddSubBlock($oAlert_69eaeee188e00329373812);
            array_push($context['UIBlockParent'], $oAlert_69eaeee188e00329373812);
            ob_start();
            // line 3
...
";
    ...
    {
        return new Source("", "templates/datamodel/ActionEmail/email-notification-preview.html.twig", "/var/www/html/templates/datamodel/ActionEmail/email-notification-preview.html.twig");
    }
}
